          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              >
                ...
                />
                <Text style={{
                  paddingLeft: 10, color: '#4A4093', fontFamily: 'Poppins', fontWeight: 'bold', fontSize: 18,
                }}>
                  {item.name}
                </Text>
...
const styles = {
  container: {
    ...
    fontFamily: 'Poppins', // Tambahkan fontFamily di level container
  },
  centeredContainer: {
    alignItems: 'center',
    margin: 0,
    fontFamily: 'Poppins', // Tambahkan fontFamily di level centeredContainer
  },
  newProdukImage: {
    margin: 0,
  ...
  Text: {
    fontFamily: 'Poppins', // Tambahkan fontFamily di level text
  },
  subscribeTitle: {
    color: 'white',
    fontSize: 20,
    fontWeight: 'bold',
    marginBottom: 10,
    fontFamily: 'Poppins', // Tambahkan fontFamily di level subscribeTitle
  },
  subscribeDescription: {
    color: '#ddd',
    textAlign: 'center',
    marginBottom: 15,
    fontFamily: 'Poppins', // Tambahkan fontFamily di level subscribeDescription
  },
  emailInputContainer: {
    flexDirection: 'row',
    alignItems: 'center',
